...
## NOTICE
This project is archived and no longer functional due to the legacy Simplenote API being shutdown as of October 1, 2018. See [link](https://simplenote.com/developers/) for more details.
